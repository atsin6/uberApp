...
import com.atulpal.project.uber.uberApp.entities.Rating;
...
import com.atulpal.project.uber.uberApp.repositories.RatingRepository;
...
public class RatingServiceImpl implements RatingService {
    ...
    public DriverDto rateDriver(Ride ride, Integer rating) {
        ...
        if(ratingObj.getDriverRating() != null){
            throw new RuntimeConflictException("Driver has already been rated, Cannot rate it again.");
        }
    ...
    public RiderDto rateRider(Ride ride, Integer rating) {
        ...
        if(ratingObj.getRiderRating() != null){
            throw new RuntimeConflictException("Rider has already been rated, Cannot rate it again.");
        }
